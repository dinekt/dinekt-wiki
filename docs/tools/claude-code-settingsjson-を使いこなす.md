...
<div class="dnk-prev-next">
  <a class="prev" href="../adr-参照コマンドによる意思決定の継承/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">ADR 参照コマンドによる意思決定の継承</span></a>
  <a class="next" href="../claude-code-のサブエージェント活用法/"><span class="dnk-pn-title">Claude Code のサブエージェント活用法</span><span class="dnk-pn-arrow">→</span></a>
</div>
