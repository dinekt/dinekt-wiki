...
<div class="dnk-prev-next">
  <a class="prev" href="../claude-code-のサブエージェント活用法/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">Claude Code のサブエージェント活用法</span></a>
  <a class="next" href="../ナレッジベースを静的-wiki-として自動公開するパイプライン/"><span class="dnk-pn-title">ナレッジベースを静的 Wiki として自動公開するパイプライン</span><span class="dnk-pn-arrow">→</span></a>
</div>
