...
<div class="dnk-prev-next">
  <a class="prev" href="../評価セットを後回しにしてリリース後に立て直した事例/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">評価セットを後回しにしてリリース後に立て直した事例</span></a>
  <a class="next" href="../評価駆動で-llm-機能をゼロから作った-5-日間の流れ/"><span class="dnk-pn-title">評価駆動で LLM 機能をゼロから作った 5 日間の流れ</span><span class="dnk-pn-arrow">→</span></a>
</div>
