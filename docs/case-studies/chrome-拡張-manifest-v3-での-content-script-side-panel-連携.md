...
<div class="dnk-prev-next">
  <a class="prev" href="../llm-エージェントに大規模リファクタリングを安全に任せる手順/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">LLM エージェントに大規模リファクタリングを安全に任せる手順</span></a>
  <a class="next" href="../nextjs-supabase-prisma-併用時の認証と-rls-の扱い方/"><span class="dnk-pn-title">Next.js + Supabase + Prisma 併用時の認証と RLS の扱い方</span><span class="dnk-pn-arrow">→</span></a>
</div>
