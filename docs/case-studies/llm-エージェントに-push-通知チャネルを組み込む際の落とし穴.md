...
<div class="dnk-prev-next">
  <a class="prev" href="../評価駆動で-llm-機能をゼロから作った-5-日間の流れ/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">評価駆動で LLM 機能をゼロから作った 5 日間の流れ</span></a>
  <a class="next" href="../llm-エージェントに大規模リファクタリングを安全に任せる手順/"><span class="dnk-pn-title">LLM エージェントに大規模リファクタリングを安全に任せる手順</span><span class="dnk-pn-arrow">→</span></a>
</div>
