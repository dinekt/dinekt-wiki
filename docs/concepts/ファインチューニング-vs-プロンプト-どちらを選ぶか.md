...
<div class="dnk-prev-next">
  <a class="prev" href="../プロンプトインジェクション-llm-アプリの最重要セキュリティ論点/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">プロンプトインジェクション — LLM アプリの最重要セキュリティ論点</span></a>
  <a class="next" href="../llm-アプリの-5-つの典型アーキテクチャパターン/"><span class="dnk-pn-title">LLM アプリの 5 つの典型アーキテクチャパターン</span><span class="dnk-pn-arrow">→</span></a>
</div>
