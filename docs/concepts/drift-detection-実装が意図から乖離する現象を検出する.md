...
flowchart TD
    ...
    style I fill:#0a0a0a,color:#fff,stroke:#0a0a0a
    style R fill:#fafafa,stroke:#525252
    style BACK fill:#f6f6f6,stroke:#c8c8c8
```
...
flowchart LR
    ...
    style P1 fill:#e8f5e9,stroke:#81c784
    style P2 fill:#e8f5e9,stroke:#81c784
    style P3 fill:#fff3e0,stroke:#ffb74d
    style P4 fill:#ffebee,stroke:#e57373
    style P5 fill:#ffcdd2,stroke:#e57373
```
