...
<div class="dnk-prev-next">
  <a class="prev" href="../llm-アプリの-5-つの典型アーキテクチャパターン/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">LLM アプリの 5 つの典型アーキテクチャパターン</span></a>
  <a class="next" href="../技術選定の5軸評価フレームワーク/"><span class="dnk-pn-title">技術選定の5軸評価フレームワーク</span><span class="dnk-pn-arrow">→</span></a>
</div>
