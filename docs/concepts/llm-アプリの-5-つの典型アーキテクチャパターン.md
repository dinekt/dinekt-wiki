...
<div class="dnk-prev-next">
  <a class="prev" href="../ファインチューニング-vs-プロンプト-どちらを選ぶか/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">ファインチューニング vs プロンプト — どちらを選ぶか</span></a>
  <a class="next" href="../ai-開発の速度と品質は両立できる/"><span class="dnk-pn-title">AI 開発の速度と品質は両立できる</span><span class="dnk-pn-arrow">→</span></a>
</div>
