...
<div class="dnk-prev-next">
  <a class="prev" href="../edge-runtime-vs-node-runtime-の使い分け/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">Edge Runtime vs Node Runtime の使い分け</span></a>
  <a class="next" href="../llm-アプリのログ設計で残すべき-5-項目/"><span class="dnk-pn-title">LLM アプリのログ設計で残すべき 5 項目</span><span class="dnk-pn-arrow">→</span></a>
</div>
