...
<div class="dnk-prev-next">
  <a class="prev" href="../llm-api-キーの管理と漏洩防止/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">LLM API キーの管理と漏洩防止</span></a>
  <a class="next" href="../ai-エージェント運用の-10-メトリクス/"><span class="dnk-pn-title">AI エージェント運用の 10 メトリクス</span><span class="dnk-pn-arrow">→</span></a>
</div>
