...
<div class="dnk-prev-next">
  <a class="prev" href="../llm-アプリのインシデント対応/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">LLM アプリのインシデント対応</span></a>
  <a class="next" href="../claude-code-の-slash-command-と-skill-の使い分け/"><span class="dnk-pn-title">Claude Code の Slash Command と Skill の使い分け</span><span class="dnk-pn-arrow">→</span></a>
</div>
