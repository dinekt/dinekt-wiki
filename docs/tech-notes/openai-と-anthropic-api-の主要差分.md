...
<div class="dnk-prev-next" markdown>
  <div class="prev">← [LLM アプリのインシデント対応](llm-アプリのインシデント対応.md)</div>
  <div class="next">[Claude Code の Slash Command と Skill の使い分け](claude-code-の-slash-command-と-skill-の使い分け.md) →</div>
</div>
