...
<div class="dnk-prev-next">
  <a class="prev" href="../openai-と-anthropic-api-の主要差分/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">OpenAI と Anthropic API の主要差分</span></a>
  <a class="next" href="../sqlite-fts5-で日本語を全文検索する/"><span class="dnk-pn-title">SQLite FTS5 で日本語を全文検索する</span><span class="dnk-pn-arrow">→</span></a>
</div>
