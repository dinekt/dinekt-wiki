...
<div class="dnk-prev-next">
  <a class="prev" href="../few-shot-examples-の効果的な設計/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">Few-shot Examples の効果的な設計</span></a>
  <a class="next" href="../推論モデル-o1o3extended-thinking-の使いどころ/"><span class="dnk-pn-title">推論モデル (o1/o3/Extended Thinking) の使いどころ</span><span class="dnk-pn-arrow">→</span></a>
</div>
