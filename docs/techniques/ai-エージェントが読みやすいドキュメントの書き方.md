...
<div class="dnk-prev-next">
  <a class="prev" href="../エージェントのメモリ設計-短期中期長期/"><span class="dnk-pn-arrow">←</span><span class="dnk-pn-title">エージェントのメモリ設計 (短期・中期・長期)</span></a>
  <a class="next" href="../claude-code-を日々使い倒す-10-の小技/"><span class="dnk-pn-title">Claude Code を日々使い倒す 10 の小技</span><span class="dnk-pn-arrow">→</span></a>
</div>
