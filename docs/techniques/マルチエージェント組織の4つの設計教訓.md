...
flowchart TD
    ...
    style I fill:#e3f2fd,stroke:#64b5f6,color:#000
...
<div class="dnk-prev-next" markdown>
  <div class="prev">← [二役レビューの実装パターン](二役レビューの実装パターン.md)</div>
  <div class="next">[LLM-as-Judge — 評価者 LLM の組み立て方](llm-as-judge-評価者-llm-の組み立て方.md) →</div>
</div>
